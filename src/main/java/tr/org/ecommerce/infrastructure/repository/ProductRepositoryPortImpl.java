...
import tr.org.ecommerce.infrastructure.repository.jpa.SpringDataProductRepository;
...
public class ProductRepositoryPortImpl implements ProductRepositoryPort {
    ...
    private ProductEntity toEntity(Product product) {
        ...
        entity.setStatus(ProductEntity.ProductStatus.valueOf(product.getStatus().name()));
